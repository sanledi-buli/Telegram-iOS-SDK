...
@implementation TLInputNotifyPeer$inputNotifyGeoChatPeer : TLInputNotifyPeer


- (int32_t)TLconstructorSignature
{
    return (int32_t)0x4d8ddec8;
}

- (int32_t)TLconstructorName
{
    return (int32_t)0x5cb0494b;
}

- (id<TLObject>)TLbuildFromMetaObject:(std::shared_ptr<TLMetaObject>)metaObject
{
    TLInputNotifyPeer$inputNotifyGeoChatPeer *object = [[TLInputNotifyPeer$inputNotifyGeoChatPeer alloc] init];
    object.peer = metaObject->getObject((int32_t)0x9344c37d);
    return object;
}
