...
- (id<TLObject>)TLbuildFromMetaObject:(std::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.real_first_name = metaObject->getString((int32_t)0x9f3a640a);
    object.real_last_name = metaObject->getString((int32_t)0x176cbb2b);
    return object;
}
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>((int32_t)0x9f3a640a, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeString;
        value.nativeObject = self.real_last_name;
        values->insert(std::pair<int32_t, TLConstructedValue>((int32_t)0x176cbb2b, value));
    }
}
