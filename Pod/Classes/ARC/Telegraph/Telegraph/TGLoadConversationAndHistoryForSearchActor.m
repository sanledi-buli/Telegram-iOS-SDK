...
- (void)execute:(NSDictionary *)options
{
    ...
    else
    {
        ...
        self.cancelToken = [TGTelegraphInstance doRequestConversationHistory:_peerId maxMid:0 orOffset:0 limit:[self loadCount] / 2 actor:(TGConversationHistoryAsyncRequestActor *)self];
    }
}
...
{
    self.cancelToken = [TGTelegraphInstance doRequestConversationHistory:_peerId maxMid:_messageId + 1 orOffset:-[self loadCount] / 2 limit:[self loadCount] actor:(TGConversationHistoryAsyncRequestActor *)self];
}
